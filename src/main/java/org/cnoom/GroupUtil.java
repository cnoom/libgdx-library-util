...
public class GroupUtil {
    ...
    public static void addActor(Group g, Actor actor) {
        addActor(g, actor, center);
    }

    public static void addActor(Group g, Actor actor, float sx, float sy) {
        addActor(g, actor, center, sx, sy);
    }
