...
public class ActorUtil {
    ...
    public static void align(Actor actor,int Align,float sx,float sy){ align(actor,Align,Align,sx,sy);}

    public static void align(Actor actor,int actorAlign,int parentAlign){align(actor,actorAlign,parentAlign,0,0);}

    public static void align(Actor actor,int Align){ align(actor,Align,Align,0,0);}
